...
object FormulaVecter{
  ...
  def normallearnver2(epochnum:Int,in:Int,hidden:Int,layernum:Int,take:Int)={
    ...
    for(e <- 0 until Exercises.size){
      ...
      for(epoch <- 0 until epochnum){
        ...
        Encoder.update
        Decoder.update
        var str_ep =String.format(" ep:%5s ",epoch.toString);
        var str_acc = String.format(" acc: %-10s",(partacc/Exercises(e).size.toFloat).toString)
        var str_perplexity = String.format(" perplexity: %20s ",math.exp(clossentropy).toString)
        ...
        println("No."+e+str_ep+str_acc+str_perplexity+str_input+str_output)
    ...
    val pathName = "txt/new/"+"E2D_EV_final_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
    ...
    val pathName2 = "txt/new/"+"E2D_EV_final_test_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
  ...
  def skiplearn(num:Int,in:Int,hidden:Int,layernum:Int,take:Int)={
    ...
    val pathName = "txt/new/"+"SkipConnect_Skip_final_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
    val writer =  new java.io.PrintWriter(pathName)
    writer.write(saveVecter)
    writer.close()
    println("success ")

    val pathName2 = "txt/new/"+"SkipConnect_Skip_test_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
    val writer2 =  new java.io.PrintWriter(pathName2)
    writer2.write(testVecter)
    writer.close()
    println("success ")
  ...
  def Bi_directional_slearn(num:Int,in:Int,hidden:Int,layernum:Int,take:Int)={
    ...
    val pathName = "txt/new/"+"BiDirection_Bi_final_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
    val writer =  new java.io.PrintWriter(pathName)
    writer.write(saveVecter)
    writer.close()
    println("success ")

    val pathName2 = "txt/new/"+"BiDirection_Bi_test_"+in+"x"+hidden+"_"+layernum+"_"+timer.date()+"_take_"+take+".txt"
    val writer2 =  new java.io.PrintWriter(pathName2)
    writer2.write(testVecter)
    writer2.close()
    println("success ")
  ...
  def normallearn(num:Int,in:Int,hidden:Int,layernum:Int,take:Int)={
    ...
    for(e <- 0 until Exercises.size){
      ...
      for(epoch <- 0 until num){
        ...
        println(str_ep+str_acc+str_perplexity+str_input+str_output)
